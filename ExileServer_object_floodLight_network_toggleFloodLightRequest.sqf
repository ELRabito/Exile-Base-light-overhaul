...
{
	_floodLight allowDamage true;
	_floodLight setHit ["light_1_hitpoint", _damage];
	_floodLight setHit ["light_2_hitpoint", _damage];
	_floodLight setHit ["light_3_hitpoint", _damage];
	_floodLight setHit ["light_4_hitpoint", _damage];
	_floodLight allowDamage false;
}
else 
{
